...
export default function Page() {
    return (
        <div className="w-screen grid md:grid-cols-3 gap-0 overflow-hidden">
            ...
            <Link href="/player/xenogelion" className="w-full h-screen max-h-[33vh] md:max-h-screen md:h-screen border relative group">
            ...
            <Link href="/player/nasuth" className="w-full h-screen max-h-[33vh] md:max-h-screen md:h-screen border relative group">
