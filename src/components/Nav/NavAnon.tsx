            ...
            <Sheet>
                ...
                <SheetContent className="w-screen bg-black text-white border-none">
                    <div className="grid gap-2 py-6">
                        {/* Party */}
                        <Link className="flex w-full items-center py-2 text-lg font-semibold" href="#party" scroll={false}>
                            Party
                        </Link>
                        {/* Campaign */}
                        <Link className="flex w-full items-center py-2 text-lg font-semibold" href="#campaign" scroll={false}>
                            Campaign
                        </Link>
                        {/* Rules */}
                        <Link className="flex w-full items-center py-2 text-lg font-semibold" href="#rules" scroll={false}>
                            Rules
                        </Link>
                        {/* Pokemon */}
                        <Link className="flex w-full items-center py-2 text-lg font-semibold" href="#allPokemon" scroll={false}>
                            Pokemon
                        </Link>
                    </div>
                </SheetContent>
